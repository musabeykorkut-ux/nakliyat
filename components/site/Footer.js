...
export default function Footer({ settings }) {
  ...
  const services = [
    { href: '/hizmetler/asansorlu-tasimacilik', label: 'Asansörlü Taşımacılık' },
    { href: '/hizmetler/sehir-ici-nakliyat', label: 'Şehir İçi Nakliyat' },
    { href: '/hizmetler/sehirler-arasi-nakliyat', label: 'Şehirler Arası Nakliyat' },
    { href: '/hizmetler/saricam-nakliyat', label: 'Sarıçam Nakliyat' },
    { href: '/hizmetler/cukurova-nakliyat', label: 'Çukurova Nakliyat' },
  ]
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <p className="text-primary-foreground/80 mb-4">
              Adana'da 10+ yıllık tecrübemizle evden eve nakliyat, asansörlü taşımacılık ve şehirler arası nakliyat hizmetleri sunuyoruz.
            </p>
            <div className="flex gap-4">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start gap-3">
                ...
                <a href={`tel:${phoneRaw}`} className="text-primary-foreground/80 hover:text-secondary transition-colors">
                  {phone}
                </a>
              </li>
              <li className="flex items-start gap-3">
                <Mail className="h-5 w-5 text-secondary mt-0.5" />
                <a href={`mailto:${email}`} className="text-primary-foreground/80 hover:text-secondary transition-colors">
                  {email}
                </a>
              </li>
              <li className="flex items-start gap-3">
      ...
      <div className="border-t border-primary-foreground/20">
        <div className="container py-4">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4 text-sm text-primary-foreground/70">
            <p>&copy; {new Date().getFullYear()} Baraj Nakliyat. Tüm hakları saklıdır.</p>
            <div className="flex gap-4">
              <Link href="/gizlilik-politikasi" className="hover:text-secondary transition-colors">Gizlilik Politikası</Link>
              <Link href="/kullanim-sartlari" className="hover:text-secondary transition-colors">Kullanım Şartları</Link>
            </div>
          </div>
        </div>
      </div>
